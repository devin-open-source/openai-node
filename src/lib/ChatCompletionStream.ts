...
export namespace ChatCompletionSnapshot {
  ...
  export namespace Choice {
    ...
    export interface Message {
      ...
      /**
       * Audio response data for audio-capable models.
       */
      audio?: {
        /**
         * The expiration timestamp for the audio data.
         */
        expires_at?: number;
        /**
         * The audio data in the specified format.
         */
        data?: string;
        /**
         * The ID of the audio response.
         */
        id?: string;
        /**
